class DeadliftAnalyzer:
    ...
    def analyze(self, landmarks_list):
        ...
        for i, landmarks in enumerate(landmarks_list):
            try:
                ...
                if self.is_setup_phase(hip, knee, ankle):
                    phases["Setup"].append(landmarks)
                elif self.is_lockout_phase(hip, shoulder, knee):
    ...
    def is_setup_phase(self, hip, knee, ankle):
        return knee["y"] < hip["y"] < shoulder["y"] and abs(ankle["y"] - knee["y"]) > 0.1

    def is_lockout_phase(self, hip, shoulder, knee):
        return abs(hip["y"] - shoulder["y"]) < 0.05 and knee["y"] < hip["y"]
